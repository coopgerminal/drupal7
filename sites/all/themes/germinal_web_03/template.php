 ...
 */
function germinal_web_03_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function germinal_web_03_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function germinal_web_03_button($element) {
...
*/
function germinal_web_03_img_assist_page($content, $attributes = NULL) {
