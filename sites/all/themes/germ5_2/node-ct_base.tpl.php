...
<?php 
		...
		<?php 
					if ($node->field_tipus[0]['view'] == 'acte')
						//Posem la data d'inici de l'acte per evitar confusions amb la data d'introducció de l'esdeveniment
		...
		<div class="art-article"><?php print $picture; ?>
			...
			/*			
			//LLP: a través de la configuració del tipus ct_base, hem fet invisibles aquells camps que no ens interessa veure
			//     en el detall del node. De tota manera, en qualsevol moment podem pintar-los aquí, ja que a $node->field...
			//     els tenim disponibles, tal i com es mostra a continuació
			...
			*/
			...
			//LLP: Si el node és tipus teaser, posem a l'esquerra la imatge petita, i si no posem la menys petita -->
			if ($node->field_imatge[0]['filepath']) //Verifiquem que existeixi la imatge, sinó queden uns espais deguts als marges que molesten
			{
				if ($teaser) 
				{ 
