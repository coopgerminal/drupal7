<?php
// $Id: hooks.php,v 1.1.2.8 2009/01/19 20:31:20 islandusurper Exp $
...
//GERMINAL ->
function hook_nom_setmana($dia) {
}

function hook_get_informacio_centre() {
}

function hook_get_informacio_soci($dia) {
}

function hook_comprova_data_limit($centre, $setmana=NULL) {
}
//GERMINAL <-
